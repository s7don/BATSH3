...
او مراسلتي ع الخاص
تم تعريب االترمنال من قبل سعدون ال مشايخ
]]
...
function load_config( )
  ...
  if not f then
    print ("\n💢¦ جاري انشاء الكونفك :\n💢¦ خلي ايديك والتوكن واسم البوت ومعرفك كمطور \n💢¦ v1 ورح يشتغل عندك السورس باتشي توكن الاصدار الاول ")
    create_config()
  else
    f:close()
  end
...
function bot_run()
	...
	bot = bot.result
	local runlog = "💢¦ تم تشغيل السيرفر \n💢¦ معرف بوتك : @"..bot.username.."\n💢¦ يعمل ع سورس باتشي توكن اصدار  v3 💯\n💢¦ تابع قناة السورس @server_iq"
	print(runlog.."\n┇-----------------------------------")
