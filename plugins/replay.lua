...
if string.match(ww, 'سعدون')  or  string.match(ww, 'شكسبير') or  string.match(ww, 'عموري') or  string.match(ww, 'عسكري')  or string.match(ww, 'ليث') then
return true
else
return false
end
...
if sudoname(ww) then
return "اموت عليةة سعدوني┇🎵™ هذا العشق😻💋"
else
